...
class Solution:
    def findMinArrowShots(self, points: List[List[int]]) -> int:
        # 贪心
        # 按区间结束坐标升序排序，每支箭至少射爆下一个气球，并且顺带射爆其他尽可能多的气球，因此只需射向下一个气球区间的结束坐标即可
        result = 1
...
if __name__ == '__main__':
    ...
    r = s.findMinArrowShots([[10, 16], [2, 8], [1, 6], [7, 12]])
    print(r)

    r = s.findMinArrowShots([[1, 2], [3, 4], [5, 6], [7, 8]])
    print(r)

    r = s.findMinArrowShots([[1, 2], [2, 3], [3, 4], [4, 5]])
    print(r)

    r = s.findMinArrowShots([[1, 2]])
    print(r)

    r = s.findMinArrowShots([[2, 3], [2, 3]])
    print(r)
